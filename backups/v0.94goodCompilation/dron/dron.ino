...
//#include <SimpleTimer.h> //será nuestra libreria de Threads (timers por software que se ejecutan paralelamente),no es una interrupción porque no para la ejecución actual, pero si se ejecuta paralelamente.
	//\_no necesaria de momento, los tiempo de estabilización son mínimos, no se necesita nada en ejecución paralela.
...
#include "dmp_vars.h"
 ...
 //Mirf
  ...
  //#include "F_HC-SR04.cpp" //funcion que devuelve distancia en cm (hasta 2m)
#endif
  ...
  //#include "F_MS5611.cpp" //funcion que devuelve distancia en cm (no tiene limite pero más inestable que hcsr04)
#endif
